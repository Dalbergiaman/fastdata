...
NODE_PARAMETER_SCHEMAS = {
    ...
    "Img2Img": [
        ...
        {"key": "concurrency", "label": "Concurrency", "type": "int", "minimum": 1, "maximum": 64},
        {"key": "poll_interval", "label": "Poll Interval", "type": "int", "minimum": 1, "maximum": 120},
        {"key": "max_retries", "label": "Max Retries", "type": "int", "minimum": 1, "maximum": 10000},
